...
<head>
    ...
    <title>YouTube MP4 • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download video MP4 YouTube" />
...
<body data-tool-key="ytmp4">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / YouTube MP4</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">YT MP4 © 2026 • RAAAN</footer>
