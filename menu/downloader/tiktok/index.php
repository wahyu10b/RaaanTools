...
<head>
    ...
    <title>TikTok • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download video, audio, dan slide TikTok" />
...
<body data-tool-key="tiktok">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / TikTok</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">TT TOOLS © 2026 • RAAAN</footer>
