...
<head>
    ...
    <title>Facebook • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download video Facebook" />
...
<body data-tool-key="facebook">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / Facebook</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">FB TOOLS © 2026 • RAAAN</footer>
