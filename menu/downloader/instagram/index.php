...
<head>
    ...
    <title>Instagram • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download Reels, foto, dan carousel Instagram" />
...
<body data-tool-key="instagram">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / Instagram</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">IG TOOLS © 2026 • RAAAN</footer>
