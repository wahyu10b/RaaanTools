...
<head>
    ...
    <title>NPM • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Ambil metadata dan tarball package NPM" />
...
<body data-tool-key="npm">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / NPM</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">NPM © 2026 • RAAAN</footer>
