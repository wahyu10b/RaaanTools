...
<head>
    ...
    <title>Upscale • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Tingkatkan kualitas gambar" />
...
<body data-tool-key="upscale">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Tools / Upscale</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">UPSCALE © 2026 • RAAAN</footer>
