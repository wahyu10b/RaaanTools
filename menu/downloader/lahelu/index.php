...
<head>
    ...
    <title>Lahelu • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download media Lahelu" />
...
<body data-tool-key="lahelu">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / Lahelu</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">LAHELU © 2026 • RAAAN</footer>
