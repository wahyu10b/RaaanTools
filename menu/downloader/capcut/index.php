...
<head>
    ...
    <title>CapCut • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Ambil video dan data template CapCut" />
...
<body data-tool-key="capcut">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / CapCut</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">CAPCUT © 2026 • RAAAN</footer>
