...
<head>
    ...
    <title>SS Web • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Screenshot website" />
...
<body data-tool-key="ssweb">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Tools / SS Web</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">SS WEB © 2026 • RAAAN</footer>
