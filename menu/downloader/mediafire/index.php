...
<head>
    ...
    <title>MediaFire • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Ambil direct download MediaFire" />
...
<body data-tool-key="mediafire">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / MediaFire</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">MEDIAFIRE © 2026 • RAAAN</footer>
