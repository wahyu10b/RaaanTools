...
<head>
    ...
    <title>X / Twitter • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download foto/video X" />
...
<body data-tool-key="x">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / X / Twitter</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">X TOOLS © 2026 • RAAAN</footer>
