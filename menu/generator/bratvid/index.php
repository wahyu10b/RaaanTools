...
<head>
    ...
    <title>BRAT Video • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Buat video singkat gaya Brat" />
...
<body data-tool-key="bratvid">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Generator / BRAT Video</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">BRAT VIDEO © 2026 • RAAAN</footer>
