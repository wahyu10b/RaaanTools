...
<head>
    ...
    <title>GitHub • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download repository GitHub ZIP" />
...
<body data-tool-key="github">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / GitHub</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">GITHUB © 2026 • RAAAN</footer>
