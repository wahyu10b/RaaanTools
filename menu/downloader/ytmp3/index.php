...
<head>
    ...
    <title>YouTube MP3 • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Download audio MP3 YouTube" />
...
<body data-tool-key="ytmp3">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Downloader / YouTube MP3</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">YT MP3 © 2026 • RAAAN</footer>
