...
<head>
    ...
    <title>BRAT Generator • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Buat gambar gaya Brat dari teks" />
...
<body data-tool-key="brat">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Generator / BRAT Generator</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">BRAT © 2026 • RAAAN</footer>
