...
<head>
    ...
    <title>RemoveBG • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Hapus background gambar" />
...
<body data-tool-key="removebg">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Tools / RemoveBG</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">REMOVE BG © 2026 • RAAAN</footer>
