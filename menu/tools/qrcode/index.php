...
<head>
    ...
    <title>QR Code • Raaan Tools</title>
    <meta name="description" content="Raaan Tools - Buat QR Code PNG" />
...
<body data-tool-key="qrcode">
                    ...
                    <div class="input-section">
                        <section class="panel input-area">
                            <div class="tabs-container">
                                <button class="tab-btn active" type="button"><span>Tools / QR Code</span></button>
                            </div>
    ...
    <footer class="footer" id="pageFooter">QR CODE © 2026 • RAAAN</footer>
